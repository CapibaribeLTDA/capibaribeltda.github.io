...
export const SERVICES_LIST = [
    {
      ...
      description: `# **Soluções Completas para Gestão de Dados Escalável**  

Projetamos, implementamos e otimizamos **infraestruturas de dados end-to-end**, garantindo alta disponibilidade, 
segurança e performance para seus pipelines analíticos e operacionais.  
...
- Migração de legacy para cloud (**AWS/GCP/Azure**)  

      `,
    },
    {
      name: "Análise de Dados",
      description: `# **Transforme dados em decisões estratégicas com análises inteligentes**  

Oferecemos soluções completas em **análise de dados** para empresas que desejam extrair insights acionáveis, otimizar operações e impulsionar resultados. Combinamos técnicas avançadas de analytics com domínio de negócios para entregar relatórios, dashboards e modelos preditivos sob medida.  
...
- Previsão de vendas e estoque (**supply chain analytics**)`,
    },
    {
      name: "Arquitetura de Dados",
      description: `# **Construímos alicerces de dados para escalabilidade e inovação**  

Projetamos e implementamos **arquiteturas de dados modernas** que unem desempenho, governança e flexibilidade. Nossas soluções transformam infraestruturas caóticas em ecossistemas dados orientados por domínio, prontos para analytics, IA e operações críticas.
...
- Arquiteturas para:  
  ...
  - MLOps (feature stores, model serving)  
...
▸ **Documentação viva** (arquitetura como código)  
...
- Sistema antifraude com streaming + batch
  `,
    },
    {
...
▸ LLMs: OpenAI, Claude, Llama 2 (custom fine-tuning)  
...
- Plataforma de crédito com avaliação alternativa  `,
    },
    {
      name: "Plataforma de Dados",
      description: `# **Sua infraestrutura completa de dados, pronta para escalar**

Oferecemos uma plataforma integrada de dados que unifica coleta, processamento, armazenamento e análise em um único ambiente. Projetada para simplificar a governança e acelerar a geração de insights com tecnologia enterprise-grade.
...
✓ Organizações com requisitos complexos de compliance  
✓ Negócios preparando adoção de IA/ML  `,
    },
    {
      name: "Desenvolvimento Full-Stack",
      description: `# **Soluções completas de software, do back-end ao front-end**

Oferecemos desenvolvimento full-stack sob medida para transformar suas ideias em aplicações robustas e escaláveis. Combinamos expertise técnica com design intuitivo para entregar produtos digitais de alto desempenho.
...
3. **Desenvolvimento** - sprints ágeis  
